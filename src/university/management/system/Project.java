...
public class Project extends JFrame implements ActionListener{
    Project(){
        ...
        JMenu master = new JMenu("New Admission");
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(msg.equals("New Student Admission")){
            ...
            try{
                Runtime.getRuntime().exec("www.technonjr.org");
            }catch(Exception e){ }
        }else if(msg.equals("Calculator")){
            try{
                Runtime.getRuntime().exec("www.yogeshkumar.ml");
            }catch(Exception e){ }
        }else if(msg.equals("Web Browser")){
            
            try{
                Runtime.getRuntime().exec("www.geeksforgeeks");
            }catch(Exception e){ }
