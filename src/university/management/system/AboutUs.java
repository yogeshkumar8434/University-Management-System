...
public class AboutUs extends JFrame{
	...
	private JPanel contentPane;
        ...
        public AboutUs() {
            ...
            super("About Us - Techno India NJR");
            ...
            JLabel l5 = new JLabel("*Techno India NJR*");
            l5.setForeground(new Color(30, 144, 255));
            l5.setFont(new Font("Trebuchet MS", Font.BOLD, 25));
            l5.setBounds(90, 140, 600, 21);
            contentPane.add(l5);


            JLabel l6 = new JLabel("Developed By: Dhanaraj Thawani, Mahendra Kumar, Yogesh Kumar ");
            l6.setFont(new Font("Trebuchet MS", Font.BOLD, 30));
            l6.setBounds(70, 198, 1000, 35);
            contentPane.add(l6);

            JLabel l7 = new JLabel("Roll Number - 19ETCCS012, 19ETCCS036, 19ETCCS085");
            l7.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
            l7.setBounds(70, 260, 1000, 34);
            contentPane.add(l7);

            JLabel l8 = new JLabel("Contact : dhanaraj@gmail.com , mahendra@gmail.com ,yogesh@gmail.com");
